...
cv2.namedWindow('Detector-Espacios-Vacios')
cv2.setMouseCallback('Detector-Espacios-Vacios', RGB)
...
#        print(row)
    ...
    cv2.imshow("Detector-Espacios-Vacios", frame)
